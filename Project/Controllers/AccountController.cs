...
namespace Project.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase ProfilePictureFile)
        {
            if (ModelState.IsValid)
            {
                if (ProfilePictureFile != null)
                {
                    ...
                    model.ProfilePicture = (DateTime.Now.ToString("yyyyMMddHHmmss") + "_User_" + ProfilePictureFile.FileName);
                }
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, LastName = model.LastName, PhoneNumber = model.PhoneNumber, Address = model.Address, IDNum = model.IDNum, ProfilePicture = model.ProfilePicture };
        ...
        private bool RegisterAMember(ApplicationUser user)
        {
            ...
            member.IDNum = user.IDNum;
            member.JoinDate = DateTime.Now.ToString();
            member.Profile =user.ProfilePicture;
